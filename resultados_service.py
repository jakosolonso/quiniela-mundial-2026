...
# Controlar desde variable de entorno: MODO_PRUEBA=true o MODO_PRUEBA=false
# Por defecto True para no activar la API accidentalmente en desarrollo.
# En Railway: Settings → Variables → MODO_PRUEBA = false
...
def obtener_resultados_de_api():
    ...
    """
    # Lee el global MODO_PRUEBA — NO redefinir localmente aquí.
    if MODO_PRUEBA:
